...
/**
 * The Enter Welcome panel.
 * This is a status screen.
 * It just says "Hello".
 * @author Ed Jenkins
 */
class EnterWelcomePanel extends JPanel implements Localized, WizardNavigator
{
     ...
     * Logger.
     */
    private static final Logger logger = Logger.getLogger(EnterWelcomePanel.class);
     ...
     * Icon.
     */
    public static final String ICON = "res/img/www.carfax.com/CARFAX.jpg";
     ...
     */
    static final String ID = "!EnterWelcomePanel";
     ...
     * The next panel.
     */
    private String strNext = EnterEULAPanel.ID;
    ...
    public EnterWelcomePanel()
    {
        ...
        pnlNorth.add(pnlIconOuter, BorderLayout.NORTH);
        ...
        pnlContent.add(jepInstructions, BorderLayout.CENTER);
    ...
    {
        strNext = EnterEULAPanel.ID;
        long lngNeed = App.getLongValue("app.disk.space.required");
        long lngHave = Config.getLongValue("sysinfo.disk.usable");
        lngNeed = lngNeed / MB;
        lngHave = lngHave / MB;
        if(lngHave < lngNeed)
        {
            StringBuilder sbError = new StringBuilder(1024);
            sbError.append("There is not enough disk space available to install this application.  ");
            sbError.append("I need ");
            sbError.append(lngNeed);
            sbError.append("MB, but there are only ");
            sbError.append(lngHave);
            sbError.append("MB available.");
            String strError = sbError.toString();
            logger.error(strError);
            Config.setValue("error.message", strError);
